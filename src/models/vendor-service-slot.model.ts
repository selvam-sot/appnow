...
import type { IVendorServiceSlot } from '../interfaces/vendor-service-slot.interface';
...
export default mongoose.model<IVendorServiceSlot & Document>(
  'VendorServiceSlot',
  VendorServiceSlotSchema,
);
