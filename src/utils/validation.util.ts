...
export const subCategoryValidationRules = {
  ...
  update: () => [
    ...
    body('description')
      .optional()
      .notEmpty()
      .withMessage('SubCategory description cannot be empty'),
...
export const vendorServiceValidationRules = {
  ...
  update: () => [body('name').notEmpty().withMessage('Name is required')],
};
...
export const idValidationRule = () => [param('id').isMongoId().withMessage('Valid ID is required')];

export const monthlyServiceValidationRules = {
  create: () => [body('month').notEmpty().withMessage('Month is required')],
  update: () => [body('month').notEmpty().withMessage('Month is required')],
};
