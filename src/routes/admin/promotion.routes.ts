...
router.route('/reorder').put(promotionController.reorderPromotions);
...
// Toggle routes
router.route('/:id/toggle-active').patch(promotionController.toggleActive);

router.route('/:id/toggle-featured').patch(promotionController.toggleFeatured);

router.route('/:id/toggle-banner').patch(promotionController.toggleBanner);
